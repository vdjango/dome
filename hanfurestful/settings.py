...
CALLBACK_URI = 'http://test.yt.terminus.plus:38089/Terminus/YTService/Analyze'
...
BROKER_URL = 'redis://127.0.0.1:6379/15'  # redis作为中间件
# BROKER_URL = 'redis://:123456@127.0.0.1:6379/5'  # redis作为中间件
